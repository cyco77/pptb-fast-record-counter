...
import iconImage from "../icon/fast-record-counter_small.png";
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <div className={styles.headerTitle}>
            <img
              src={iconImage}
              alt="Fast Record Counter Icon"
              className={styles.headerIcon}
            />
            <Title3>Fast Record Counter</Title3>
            <Text className={styles.subtitle}>
              Count records across all entities in your environment
            </Text>
          </div>
        </div>
